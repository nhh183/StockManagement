        ...
        try {
            switch (action) {
                ...
                case "updateUser":
                    ...
                    break;
                case "addTransaction":
                    url = "CreateTransactionController";
                    break;
                case "updateTransaction":
                    url = "UpdateTransactionPageController";
                    break;
                case "deleteTransaction":
                    url = "deleteTransactionController";
                    break;
                case "searchTransaction":
                    url = "SearchTransactionController";
                    break;
                case "createAlert":
                    url = "CreateAlertController";
                    break;
                case "updateAlert":
                    url = "UpdateAlertController";
                    break;
                case "deleteAlert":
                    url = "DeleteAlertController";
                    break;
                case "searchAlert":
                    url = "SearchAlertController";
                    break;
                case "userList":
                    url = "UserList";
                    break;
