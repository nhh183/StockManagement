...
public class CreateUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userID.isEmpty() || fullName.isEmpty() || roleID.isEmpty() || password.isEmpty()) {
                request.setAttribute("MSG", "Please fill in all fields");
                request.getRequestDispatcher("addUser.jsp").forward(request, response);
                return;
            }
            UserDAO newUserDAO = new UserDAO();
            if (newUserDAO.getUserByID(userID) != null) {
                request.setAttribute("MSG", "UserID is already exits");
                request.getRequestDispatcher("addUser.jsp").forward(request, response);
                return;
